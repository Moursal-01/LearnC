#include <stdio.h>
#include <stdlib.h>
#include <math.h> //Bibliotheque pour des fonctions mathematiques
...
int main()
{
    ...
    /*    printf("Hello world!\n\n"); // Cette instruction affiche Hello world ! a l'ecran et revient a la ligne
        ...
        // On initialise la variable age a 0
    ...
    */
    ...
    /*
        ...
        double divfloat = 0.0;
        divfloat = 5.0 / 2.0;
        printf("5.0 / 2.0 = %.2f", divfloat); // Affiche 2,50 parceque c'est des flottants et on a demander 2 chiffres apres la virgule
        printf("\n\n");                       // On revient 2 fois a la ligne pour rendre claire le code
        ...
        int restediv = 0;                 // Declaration et initialisation de la variable
        ...
        printf("\n\n");                   // Retour a la ligne pour une meilleure lisibilites
    ...
    */
    ...
    // Ce programme fait la somme de 2 entiers entrer par l'utilisateur et affiche le resultat
    /** Mon programme **/
    /*
    ...
    */
    ...
    /*
        //Fonction qui permet de calculer la puissance de 2 nombres entiers entrer par l'utilisateur
        int aa=0, bb=0, cc=0;
    ...
    */
    ...
    /*
        //Fonction qui permet de calculer la puissance de 2 nombres flottantes entrer par l'utilisateur
    ...
    */
    ...
    /*
        ...
        //Fonction qui calcul la racine carre d'un nombre entree
        double initia=0.0, valeur=0.0;
        printf("Entrez la valeur pour calculer la racine carre: \n");
        scanf("%lf", &valeur);//Ne pas oublier & devant la variable valeur
        initia=sqrt(valeur);
        printf("La racine carre de %lf est : %lf \n", valeur, initia); //%lf affiche tous les chiffres apres la virgule
    */
